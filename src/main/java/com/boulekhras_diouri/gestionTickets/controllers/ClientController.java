package com.boulekhras_diouri.gestionTickets.controllers;
...
import com.boulekhras_diouri.gestionTickets.security.services.SecurityUtils;
...
public class ClientController {
	 ...
	 private SecurityService securityService;
	    ...
	    public String client(Model model) {
			System.out.println( " gggggggggggggggggggggg "+clientService.findIdByUsername(SecurityUtils.getUserName()));
